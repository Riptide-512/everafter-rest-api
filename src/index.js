...
import guestList from './routes/guest-list.js'
import giftRegistry from './routes/gift-registry.js'
...
api.route('/guest-list', guestList)
api.route('/gift-registry', giftRegistry)
